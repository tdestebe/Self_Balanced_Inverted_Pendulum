...
This project aims to build an inverted pendulum stabilized by a single reaction wheel. The position of the pendulum is detected by a 3-axis analog gyroscope sensor (MPU6050 module). The position is analyzed inside an Arduino Nano that sends appropriate signals to a motor (Nidec 24H404H160). 
